...
for phrase1 in unique_lettered_2words[:middle_index]:
...
print('Finished filtering unique lettered 4 words: '+str(time.time() - start_time))
logging.info('Finished filtering unique lettered 4 words: '+str(time.time() - start_time))
